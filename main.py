...
while menu_iniciar != 6:
    ...
    if menu_iniciar == 1:
        ...
        if calculo_imc != 0 and meta_hidratacao != 0 and calorias_gastas != 0:
            print("Aqui vai seu resumo diário:")
            print("Se você seguiu as metas e orientações corretamente, seu IMC é de: ",calculo_imc)
            print("Você bebeu, em média,", meta_hidratacao, "litros de água.")
